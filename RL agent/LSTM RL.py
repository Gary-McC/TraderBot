...
def read_convert_data(symbol='None'):
    prices = pd.read_csv("C:/Users/Annoy/Desktop/Projects/Trading RL/BTC-USD_Megafile_01_31_2020-03_02_2020.csv")
    prices.to_pickle("C:/Users/Annoy/Desktop/Projects/Trading RL/BTC-USD_Megafile_01_31_2020-03_02_2020.pkl")
    print(prices)
    return
...
def load_data(test=False):
    ...
    prices = pd.read_pickle("C:/Users/Annoy/Desktop/Projects/Trading RL/BTC-USD_Megafile_01_31_2020-03_02_2020.pkl")
...
def init_state(indata, test=False):
    ...
    if test == False:
        ...
        joblib.dump(scaler, 'C:/Users/Annoy/Desktop/Projects/Trading RL/scaler.pkl')
    elif test == True:
        scaler = joblib.load('C:/Users/Annoy/Desktop/Projects/Trading RL/scaler.pkl')
        xdata = np.expand_dims(scaler.fit_transform(xdata), axis=1)
    state = xdata[0:1, 0:1, :]
...
plt.savefig('plt/summary'+'.png', pad_inches=1, dpi=72)
#plt.show()